...
I designed this website for a friend's family restaurant. I worked with the client to design a site that met their requirements and expectations. 
Mobile-first responsive design and a single-page design using React keeps the site flexible and quick.

- Modular design with react
- Responsive, mobile-first layout
- Selective component routing
- Image slider and other custom styling
